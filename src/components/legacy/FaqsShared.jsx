...
if (typeof window !== 'undefined') {
  Object.assign(window, { SiteNav, NAV_ITEMS, PRODUCT_LINKS });
}
...
const PRODUCTS = [
  {
    ...
    bullets: [
      { t: 'Omnichannel registration', d: 'QR code on packaging, website link, and automatic registration for Shopify orders.', Preview: getWindowMock('OmnichannelMock') },
      { t: 'Digital warranty',         d: 'Digital warranty card and a self-serve customer portal — no more paper.',           Preview: getWindowMock('DigitalWarrantyMock') },
      { t: 'Post-registration upsells',d: 'Trigger upsell offers at the exact moment a customer completes registration.',     Preview: getWindowMock('PostRegUpsellMock') },
    ],
  ...
  },
  {
    ...
    bullets: [
      { t: 'Serial number validation', d: 'Catch fraudulent and duplicate claims before they are processed.',                  Preview: getWindowMock('SerialValidationMock') },
      { t: 'Smart ticket routing',     d: 'Automatic assignment with priority levels and real-time status tracking.',          Preview: getWindowMock('TicketRoutingMock') },
      { t: 'Service workflow tracking',d: 'Repair, replacement, shipment, dealer payment, and OEM chargeback in one workflow.',Preview: getWindowMock('WorkflowMock') },
    ],
  ...
  },
  {
    ...
    bullets: [
      { t: 'Multi-touchpoint offers',    d: 'Product page, checkout, post-purchase, and inside the registration flow.', Preview: getWindowMock('MultiTouchpointMock') },
      { t: 'Native ecommerce',           d: 'Connect natively with Shopify and other ecommerce platforms.',             Preview: getWindowMock('NativeEcommerceMock') },
      { t: 'Self-serve plan management', d: 'Customers activate, view, and renew plans from a self-serve portal.',      Preview: getWindowMock('SelfServePlansMock') },
    ],
  ...
  },
  {
    ...
    bullets: [
      { t: 'Warranty performance',         d: 'Track registration rates, claim volumes, and resolution times across every product.', Preview: getWindowMock('PerformanceMock') },
      { t: 'Defect trend detection',       d: 'Identify high-defect products before they become a cost problem.',                    Preview: getWindowMock('DefectTrendMock') },
      { t: 'Revenue opportunity insights', d: 'Spot upsell opportunities based on warranty expiry and customer activity.',           Preview: getWindowMock('RevenueOppMock') },
    ],
  ...
  const personas = [
    {
      ...
      Visual: getWindowMock('MarketerAudienceMock'),
    },
    {
      ...
      Visual: getWindowMock('WarrantyInboxMock'),
    },
    {
      role: 'Business owner',
      ...
      Visual: getWindowMock('BusinessOwnerPLMock'),
    },
  ];
...
export { SiteNav, LogoCloud, FinalCTA, SiteFooter };
