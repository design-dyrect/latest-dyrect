...
var { useEffect: prmUE, useState: prmUS, useRef: prmUR } = React;
...
var { useEffect: prsUE, useState: prsUS, useRef: prsUR } = React;
...
function PrApp() {
  const [tweaks, setTweak] = useTweaks(PR_TWEAK_DEFAULTS);
  prUseReveal();
