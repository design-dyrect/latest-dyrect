...
const PRODUCTS = [
  {
    ...
    href: FEATURE_URLS.productRegistration,
  },
  {
    key: 'claims',
    ...
    href: FEATURE_URLS.warrantyManagement,
  },
  {
    key: 'warranties',
    ...
    href: FEATURE_URLS.extendedWarranties,
  },
  {
    key: 'analytics',
      ...
      <div className="container">
        ...
        <div style={{
          ...
          <div>
            ...
            <a href={p.href || FEATURE_URLS.contact} style={{
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1.1fr 1fr', gap: 64, alignItems: 'center' }} className="shopify-grid">
          <div>
            ...
            <div style={{ display: 'flex', gap: 12, marginTop: 28 }}>
              <a href={FEATURE_URLS.shopifyWarranty} className="btn btn-primary">Install on Shopify</a>
              <a href={FEATURE_URLS.integrations} className="btn btn-ghost">See all integrations &nbsp;→</a>
            </div>
          </div>
          <div>
            {steps.map((s, i) => (
      ...
      <div className="container">
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.1fr', gap: 64, alignItems: 'center' }} className="integrations-grid">
          <div>
            ...
            <a href={FEATURE_URLS.integrations} style={{
              display: 'inline-flex', alignItems: 'center', gap: 6,
      ...
      <div className="container">
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.6fr', gap: 64 }} className="faq-grid">
          <div>
            ...
            <a href={FEATURE_URLS.contact} className="btn btn-secondary" style={{ marginTop: 16 }}>
              Talk to sales →
            </a>
          </div>
        ...
        <div style={{
          ...
          <div style={{ position: 'relative', maxWidth: 720 }}>
            ...
            <div style={{ display: 'flex', gap: 12, marginTop: 32, flexWrap: 'wrap' }}>
              <a href={FEATURE_URLS.contact} style={{
                display: 'inline-flex', alignItems: 'center', gap: 8,
              ...
              <a href={FEATURE_URLS.shopifyWarranty} style={{
                display: 'inline-flex', alignItems: 'center', gap: 8,
                padding: '14px 22px', borderRadius: 8,
...
function SiteFooter({ activeProduct }) {
  const productLinks = [
    { l: 'Product Registration Software', href: FEATURE_URLS.productRegistration, key: 'product-registration' },
    { l: 'Warranty Management Software',  href: FEATURE_URLS.warrantyManagement, key: 'warranty-claims' },
    { l: 'Extended Warranties',           href: FEATURE_URLS.extendedWarranties, key: 'extended-warranties' },
  ...
  const cols = [
    { h: 'Products', links: productLinks },
    {
      h: 'Free Tools',
      links: [
        { l: 'Bulk QR Code Generator', href: FEATURE_URLS.bulkQr },
        { l: 'Serial Number Generator', href: FEATURE_URLS.serialNumber },
        { l: 'Warranty Cost Calculator', href: FEATURE_URLS.warrantyCost },
      ],
    },
    {
      h: 'Solutions',
    ...
    },
    {
      h: 'Company',
      links: [
        { l: 'Features', href: FEATURE_URLS.features },
        { l: 'Pricing', href: FEATURE_URLS.pricing },
        { l: 'Contact Us', href: FEATURE_URLS.contact },
      ],
      sub: {
        h: 'Features',
        links: [
          { l: 'Digitalize Warranty', href: FEATURE_URLS.digitalWarrantyCard },
          { l: 'Form Builder (No-Code)', href: FEATURE_URLS.formBuilder },
          { l: 'Digitize Product Manual', href: FEATURE_URLS.productManual },
          { l: 'Serial Number Validator', href: FEATURE_URLS.productSerialization },
          { l: 'Claims Management', href: FEATURE_URLS.claimsManagement },
          { l: 'All Features', href: FEATURE_URLS.features },
        ],
      },
    },
    {
      h: 'Resources',
      links: [
        { l: 'FAQs', href: FEATURE_URLS.faqs },
        { l: 'Blog', href: FEATURE_URLS.blog },
        { l: 'Integrations', href: FEATURE_URLS.integrations },
        { l: 'Brand Warranties', href: FEATURE_URLS.warranty },
        { l: 'Our Partners', href: FEATURE_URLS.partners },
      ],
      sub: {
        h: 'Alternatives',
        links: [
          { l: 'Google Forms vs Dyrect', href: FEATURE_URLS.googleFormsComparison },
          { l: 'Manual Leaflet vs Dyrect', href: FEATURE_URLS.leafletComparison },
          { l: 'Website Forms vs Dyrect', href: FEATURE_URLS.websiteFormsComparison },
        ],
      },
    },
  ];
      ...
      <div className="container" style={{ position: 'relative' }}>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', gap: 20 }}>
            <a href={FEATURE_URLS.privacy} style={{ color: 'inherit', transition: 'color 160ms' }}
            ...
            <a href={FEATURE_URLS.terms} style={{ color: 'inherit', transition: 'color 160ms' }}
            ...
            <a href={FEATURE_URLS.security} style={{ color: 'inherit', transition: 'color 160ms' }}
            ...
            <a href={FEATURE_URLS.status} style={{ color: 'inherit', transition: 'color 160ms' }}
...
const FI = {
  ...
  'palette':      <><path d="M12 2a10 10 0 1 0 0 20 2.5 2.5 0 0 0 2.5-2.5c0-.6-.2-1.1-.6-1.5-.4-.4-.6-.9-.6-1.5a2.5 2.5 0 0 1 2.5-2.5H19a3 3 0 0 0 3-3 9 9 0 0 0-10-9z"/><circle cx="7.5" cy="10.5" r="1" fill="currentColor" stroke="none"/><circle cx="12" cy="7" r="1" fill="currentColor" stroke="none"/></>,
  'chart-bar':    <><path d="M3 3v18h18"/><rect x="7" y="11" width="3" height="6" rx="0.5"/><rect x="12" y="7" width="3" height="10" rx="0.5"/><rect x="17" y="13" width="3" height="4" rx="0.5"/></>,
  'gauge':        <><path d="M3.5 19a10 10 0 1 1 17 0"/><path d="M12 14 9 11"/><circle cx="12" cy="14" r="1.4" fill="currentColor" stroke="none"/></>,
  'trend':        <><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/><polyline points="17 6 23 6 23 12"/></>,
  ...
  'csv':          <><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><path d="M14 2v6h6M8 13h8M8 17h5"/></>,
...
function FeatIcon({ name, size = 20 }) {
  return (
...
function FeatureCard({ icon, title, desc }) {
  ...
  return (
    <div onMouseEnter={() => setHov(true)} onMouseLeave={() => setHov(false)} style={{
      ...
      border: '1px solid var(--border-default)',
      borderRadius: 12,
      boxShadow: hov ? '0 8px 24px rgba(15,23,42,0.08)' : 'none',
      ...
      <div style={{ fontSize: 14, fontWeight: 600, color: '#0F172A', marginBottom: 6, lineHeight: 1.35 }}>{title}</div>
      <div style={{ fontSize: 13.5, lineHeight: 1.65, color: '#475569' }}>{desc}</div>
    </div>
  );
}
...
/* ─── 8 Pillars ─── */
const PILLARS = [
  { id: 'product-registration', label: 'Product Registration' },
  { id: 'digital-warranty-card', label: 'Digital Warranty Card' },
  { id: 'product-serialization', label: 'Product Serialization' },
  { id: 'claims-management',    label: 'Claims Management' },
  { id: 'extended-warranties',  label: 'Extended Warranties' },
  { id: 'customer-portal',      label: 'Customer Portal' },
  { id: 'form-builder',         label: 'Form Builder' },
  { id: 'experience-builder',   label: 'Experience Builder' },
  { id: 'digital-product-manuals', label: 'Product Manuals' },
  { id: 'analytics',            label: 'Analytics and Insights' },
  { id: 'platform',             label: 'Platform and Integrations' },
];
...
function SidebarNav() {
  ...
  useEffect(() => {
    const els = PILLARS.map(p => document.getElementById(p.id)).filter(Boolean);
  ...
  return (
    <aside className="features-sidebar" style={{
      position: 'sticky', top: 0,
      ...
      <div style={{ padding: '32px 28px 20px' }}>
        ...
        <div style={{ height: 2, background: 'var(--color-brand-blue)', marginTop: 10, borderRadius: 1 }} />
      </div>
      ...
      <nav aria-label="Feature sections">
        {PILLARS.map(p => {
          ...
          return (
            <button key={p.id} onClick={() => scrollTo(p.id)} style={{
              display: 'block', width: '100%', textAlign: 'left',
              padding: '16px 28px',
              fontSize: 14.5, fontWeight: isActive ? 600 : 400,
              color: isActive ? 'var(--color-brand-blue)' : '#334155',
              background: isActive ? 'rgba(36,55,246,0.04)' : 'transparent',
              cursor: 'pointer', fontFamily: 'var(--font-body)',
              borderBottom: '1px solid var(--border-default)',
              borderLeft: isActive ? '3px solid var(--color-brand-blue)' : '3px solid transparent',
              transition: 'all 160ms',
            }}
              onMouseEnter={e => { if (!isActive) { e.currentTarget.style.color = 'var(--color-brand-blue)'; e.currentTarget.style.background = 'rgba(36,55,246,0.03)'; } }}
              onMouseLeave={e => { if (!isActive) { e.currentTarget.style.color = '#334155'; e.currentTarget.style.background = 'transparent'; } }}>
              {p.label}
            </button>
          );
        })}
...
function FeaturesHero() {
  const stats = [
    { n: '4 Mn+', l: 'customers served' },
    { n: '500+',  l: 'brands on Dyrect' },
    { n: '4.8 ★', l: 'rated on G2' },
    { n: '5 ★',   l: 'rated on Shopify' },
  ];
  return (
    <section style={{
      ...
      <div style={{ maxWidth: 760, margin: '0 auto' }}>
        <p className="eyebrow" style={{ marginBottom: 16 }}>Features</p>
        <h1 className="section-title" style={{ fontSize: 'clamp(32px, 5vw, 54px)', letterSpacing: '-1.8px', lineHeight: 1.06 }}>
          Every feature your warranty operation needs, <span className="em">built in</span>
        </h1>
        <p style={{ marginTop: 20, fontSize: 18, lineHeight: 1.65, color: '#475569', maxWidth: 600, margin: '20px auto 0' }}>
          Product registration, claims management, extended warranties, and post-sale analytics. One platform for the full warranty lifecycle.
        </p>
        <div style={{ display: 'flex', gap: 12, justifyContent: 'center', marginTop: 36, flexWrap: 'wrap' }}>
          <a href={FEATURE_URLS?.contact || 'https://www.dyrect.co/contact-us'} className="btn btn-primary btn-lg">
            Get a Demo
          ...
          <a href="#product-registration" className="btn btn-secondary btn-lg"
            onClick={e => { e.preventDefault(); window.scrollTo({ top: (document.getElementById('product-registration')?.getBoundingClientRect().top || 0) + window.scrollY - 24, behavior: 'smooth' }); }}>
            Explore features
          </a>
        </div>
      </div>
      ...
      <div style={{
        ...
        borderTop: '1px solid var(--border-default)', paddingTop: 40,
        gap: 0,
      }} className="stats-grid">
        {stats.map((s, i) => (
          <div key={i} style={{
            flex: '1 1 130px', textAlign: 'center', padding: '0 20px',
            borderLeft: i > 0 ? '1px solid var(--border-default)' : 'none',
          }}>
            <div style={{ fontSize: 'clamp(24px, 3vw, 34px)', fontWeight: 700, color: '#0F172A', letterSpacing: '-0.8px', fontVariantNumeric: 'tabular-nums' }}>{s.n}</div>
            <div style={{ fontSize: 13, color: '#64748B', marginTop: 4, fontWeight: 500 }}>{s.l}</div>
          </div>
        ))}
      </div>
    </section>
...
const SECTION_DATA = [
  {
    ...
    eyebrow: 'Product Registration and Upsell',
    headline: 'Turn every buyer into a reachable customer',
    headlineEm: 'reachable customer',
    body: 'Most products are sold through Amazon, retail, and distributors. The buyer\'s contact details never reach the brand. Dyrect captures first-party data at the point of product registration so every buyer, regardless of purchase channel, becomes a direct contact you own and can re-market to.',
    productPage: '/product/product-registration-software',
    productLabel: 'See Product Registration Software',
    items: [
      { icon: 'qr',    title: 'Omnichannel registration',    desc: 'Capture registrations from QR codes on packaging, your website, your Shopify store, and offline channels. One system for every touchpoint.' },
      { icon: 'form',  title: 'No-code experience builder',  desc: 'Design your registration form and post-registration page without writing code. Change any field or layout from the dashboard in minutes.' },
      { icon: 'tag',   title: 'Custom form fields',          desc: 'Collect serial numbers, proof of purchase, purchase channel, product variant, and any field your warranty policy requires.' },
      { icon: 'card',  title: 'Digital warranty cards',      desc: 'Replace paper cards with a digital record linked to the product and purchase. Customers access warranty status any time, from any device.' },
      { icon: 'scan',  title: 'Automatic Shopify sync',      desc: 'Orders placed on Shopify register automatically. No customer action needed. Every Shopify buyer becomes a registered contact.' },
      { icon: 'globe', title: 'Multi-language support',      desc: 'Serve customers in their own language. Registration forms and confirmation emails localize automatically based on browser locale.' },
      { icon: 'gift',  title: 'Post-registration upsell',    desc: 'Trigger an extended warranty offer or a related product recommendation right after the customer registers. Capture revenue at peak intent.' },
      { icon: 'book',  title: 'Product manual digitization', desc: 'Replace printed manuals with a QR code linking to the latest product guide, safety notes, or instructional video. Always current.' },
    ],
  },
  {
    id: 'digital-warranty-card',
    eyebrow: 'Digital Warranty Card',
    headline: 'Replace paper warranty cards with a live ownership record',
    headlineEm: 'live ownership record',
    body: 'Dyrect gives every registered customer a digital warranty card connected to the product, purchase details, coverage period, and service history. Customers can access the record any time, while your team gets a cleaner source of truth for warranty validation.',
    productPage: null,
    productLabel: null,
    items: [
      { icon: 'card', title: 'Customer-owned warranty record', desc: 'Every registered product gets a digital card with coverage status, expiry date, product details, and ownership information in one place.' },
      { icon: 'shield-check', title: 'Coverage visibility', desc: 'Customers and service teams can instantly see whether a product is active, expired, or eligible for extended coverage.' },
      { icon: 'mail', title: 'Automated delivery', desc: 'Send digital warranty cards by email after registration or purchase, with branded copy and links back to your customer portal.' },
      { icon: 'ticket', title: 'Connected claim journey', desc: 'When a customer files a claim, the same warranty card record helps validate coverage, purchase proof, and product ownership faster.' },
      { icon: 'palette', title: 'Fully branded experience', desc: 'Cards use your brand colors, copy, logo, and domain so customers experience the warranty as part of your product ecosystem.' },
      { icon: 'history', title: 'Lifecycle history', desc: 'Keep product registration, warranty activation, claim activity, repairs, and replacement history attached to one durable ownership record.' },
    ],
  },
  {
    id: 'product-serialization',
    eyebrow: 'Product Serialization',
    headline: 'Validate every product with serial and QR-based identity',
    headlineEm: 'serial and QR-based identity',
    body: 'Dyrect helps brands connect every physical product to a unique serial number, QR code, warranty record, and owner profile. This makes registration, claims, fraud checks, and service history easier to verify across ecommerce, retail, marketplace, and offline channels.',
    productPage: null,
    productLabel: null,
    items: [
      { icon: 'scan', title: 'Serial number validation', desc: 'Check serial numbers during registration or claim submission so invalid, duplicate, or expired products are flagged early.' },
      { icon: 'qr', title: 'QR-based product identity', desc: 'Use QR codes on packaging, manuals, inserts, or product labels to connect buyers directly to the right registration flow.' },
      { icon: 'shield', title: 'Fraud reduction', desc: 'Compare product identity, purchase proof, owner data, and claim history before approving warranty service or replacement requests.' },
      { icon: 'layers', title: 'SKU and variant mapping', desc: 'Link serial numbers to product models, variants, regions, batches, and warranty policies for more accurate lifecycle tracking.' },
      { icon: 'refresh', title: 'Ownership transfer support', desc: 'Maintain a clean history when ownership changes, replacements are issued, or refurbished products re-enter circulation.' },
      { icon: 'chart-bar', title: 'Traceability analytics', desc: 'Track serial usage, registration rates, claim frequency, and product lifecycle activity across batches and channels.' },
    ],
  },
  {
    id: 'claims-management',
    eyebrow: 'Claims and Service Management',
    headline: 'Resolve every claim without losing track of a single one',
    headlineEm: 'losing track of a single one',
    body: 'Fragmented claim handling costs more than the warranty itself. Dyrect gives your service team one workspace to validate, route, track, and close every claim across every product line. No tool switching, no manual lookups, no missed follow-ups.',
    productPage: '/product/warranty-management-software',
    productLabel: 'See Warranty Management Software',
    items: [
      { icon: 'scan',         title: 'Serial number validation',        desc: 'Every claim checks the product serial number against your registry before a ticket opens. Expired or invalid claims surface before they cost you anything.' },
      { icon: 'ticket',       title: 'Claim ticket management',         desc: 'One inbox for every claim across every product line. Assign, route, escalate, and close tickets from a single workspace.' },
      { icon: 'shield-check', title: 'Warranty eligibility check',      desc: 'Purchase date, coverage period, and product category are verified automatically. No manual lookup required per incoming claim.' },
      { icon: 'refresh',      title: 'Repair, replacement, and refund', desc: 'Route each claim to the right resolution type. Track every service step from first contact to close for every open ticket.' },
      { icon: 'bell',         title: 'Customer status notifications',   desc: 'Notify customers automatically at each claim stage. Reduce inbound support volume without manual follow-up from your team.' },
      { icon: 'users',        title: 'Team assignments and notes',      desc: 'Keep claim ownership, service notes, and action history organized. Every agent sees exactly what they need to act.' },
      { icon: 'truck',        title: 'Shipment and dealer payouts',     desc: 'Track every replacement shipment inside the claim ticket. Manage dealer and service center reimbursements from the same dashboard.' },
      { icon: 'upload',       title: 'Document and photo upload',       desc: 'Let customers attach fault evidence, receipts, or photos directly to their claim. No email back-and-forth to collect evidence.' },
    ],
  },
  {
    id: 'extended-warranties',
    eyebrow: 'Extended Warranties',
    headline: 'Sell protection plans and keep 100% of the revenue',
    headlineEm: '100% of the revenue',
    body: 'Third-party warranty providers take a cut of every plan sold. Dyrect lets your brand offer protection plans at the product page, checkout, and after purchase. All revenue stays with your brand. No revenue share, no customer data passed to a third party.',
    productPage: '/product/extended-warranties',
    productLabel: 'See Extended Warranties',
    items: [
      { icon: 'tag',     title: 'Multi-touchpoint plan offers', desc: 'Place protection plan offers on the product page, at checkout, and in post-purchase emails. Reach buyers at every point of intent.' },
      { icon: 'form',    title: 'No-code plan builder',         desc: 'Set coverage terms, pricing, deductibles, and exclusions without engineering. Launch a new plan configuration in a single day.' },
      { icon: 'wallet',  title: '100% revenue in-house',        desc: 'No third-party revenue share. Every protection plan sold stays entirely with your brand across every product line.' },
      { icon: 'sliders', title: 'Dynamic pricing rules',        desc: 'Price plans by product category, price band, or coverage duration. Set rules once and let them run across your catalog.' },
      { icon: 'check',   title: 'Automatic plan activation',    desc: 'Plans activate the moment a qualifying purchase is made. No manual intervention needed from your team.' },
      { icon: 'shield',  title: 'Claims tied to the plan',      desc: 'Extended warranty claims flow into the same workspace as standard tickets. One system for all claims, covered or not.' },
      { icon: 'store',   title: 'Shopify and WooCommerce native', desc: 'Protection plan offers appear as native widgets in your Shopify or WooCommerce store. No custom code required.' },
      { icon: 'palette', title: 'White-label customer portal',  desc: 'Customers manage plans and file claims from a portal that carries your brand name, colors, and domain.' },
    ],
  },
  {
    id: 'customer-portal',
    eyebrow: 'Customer Portal',
    headline: 'Give buyers a place to manage everything after purchase',
    headlineEm: 'everything after purchase',
    body: 'The customer experience does not end at the sale. Dyrect gives every registered buyer a branded self-serve portal to view their product details, warranty status, and service history without calling your support team.',
    productPage: null,
    productLabel: null,
    items: [
      { icon: 'eye',        title: 'Self-serve warranty status',    desc: 'Customers check coverage, expiry date, and product details on their own without raising a support ticket or calling your team.' },
      { icon: 'ticket',     title: 'Online claim submission',       desc: 'Buyers file claims from the portal with guided steps, photo upload, and real-time status tracking throughout the process.' },
      { icon: 'history',    title: 'Repair and service tracking',   desc: 'Customers see every stage of the service process from claim open to resolution, updated automatically as status changes.' },
      { icon: 'card',       title: 'Digital warranty card access',  desc: 'The warranty card is accessible from the portal any time, from any device, for the lifetime of the product.' },
      { icon: 'palette',    title: 'Branded portal experience',     desc: 'Logo, colors, domain, and copy match the brand throughout. No Dyrect branding is visible to the customer at any point.' },
      { icon: 'layers',     title: 'Multi-product dashboard',       desc: 'Customers who register multiple products see all of them in one place with a single login and a clear product timeline.' },
    ],
  },
  {
    id: 'form-builder',
    eyebrow: 'Form Builder',
    headline: 'Build any registration or claim form without writing code',
    headlineEm: 'without writing code',
    body: 'Every brand has different warranty policies and different data requirements. Dyrect\'s form builder lets you create the exact form your business needs, with conditional logic, custom field types, and multi-step flows, with no developer involved.',
    productPage: null,
    productLabel: null,
    items: [
      { icon: 'move',   title: 'Drag-and-drop field editor',  desc: 'Add, remove, and reorder fields with a visual editor. No code required at any step. Publish the form when it looks right.' },
      { icon: 'zap',    title: 'Conditional field logic',     desc: 'Show or hide fields based on previous answers. Capture only what each product or claim type actually needs from the customer.' },
      { icon: 'layers', title: 'Custom field types',          desc: 'Text, dropdown, date picker, file upload, serial number field, and image capture. Any field type your policy requires is available.' },
      { icon: 'repeat', title: 'Multi-step form flows',       desc: 'Break long registration or claim forms into steps to reduce drop-off and keep completion rates high across product lines.' },
      { icon: 'shield', title: 'Policy and terms display',    desc: 'Show warranty terms, coverage conditions, and exclusions inside the form at the right moment, tied to the specific product.' },
      { icon: 'chart-bar', title: 'Form completion analytics', desc: 'See completion rates, drop-off points, and field-level abandonment for every form you publish to identify and fix problem areas.' },
    ],
  },
  {
    id: 'experience-builder',
    eyebrow: 'Experience Builder',
    headline: 'Design the post-purchase experience your brand deserves',
    headlineEm: 'post-purchase experience',
    body: 'The registration confirmation page, the warranty card email, the claim status update. Every touchpoint after the sale is a chance to reinforce the brand and reduce support load. Dyrect gives you full control over all of it without engineering resources.',
    productPage: null,
    productLabel: null,
    items: [
      { icon: 'palette',   title: 'Branded registration pages', desc: 'Match fonts, colors, and layout to your product packaging and website. No Dyrect template or branding is visible to the customer.' },
      { icon: 'mail',      title: 'Custom confirmation emails', desc: 'Design the registration confirmation and warranty card email with your own copy, logo, and call-to-action. Sent from your domain.' },
      { icon: 'card',      title: 'Warranty card design',       desc: 'Choose the layout and information displayed on the digital warranty card for each product line independently.' },
      { icon: 'gift',      title: 'Post-registration upsell',   desc: 'Show a protection plan offer or a product recommendation on the confirmation page right after registration is complete.' },
      { icon: 'form',      title: 'No-code page editor',        desc: 'Edit any page element visually. Publish changes without a developer, a deployment pipeline, or a design agency involved.' },
      { icon: 'eye',       title: 'Preview before publishing',  desc: 'See exactly how the experience looks on mobile and desktop before any customer encounters it. Publish when confident.' },
    ],
  },
  {
    id: 'digital-product-manuals',
    eyebrow: 'Digital Product Manuals and Guides',
    headline: 'Turn static manuals into searchable post-purchase support',
    headlineEm: 'searchable post-purchase support',
    body: 'Dyrect lets brands replace printed manuals with digital guides connected to the customer portal and registered product record. Customers can find setup instructions, care tips, warranty details, safety information, and service resources without opening a support ticket.',
    productPage: null,
    productLabel: null,
    items: [
      { icon: 'book', title: 'Digital manuals by product', desc: 'Attach manuals, setup guides, troubleshooting content, and care instructions to each registered product or SKU.' },
      { icon: 'qr', title: 'QR access from packaging', desc: 'Let customers scan a QR code on the product, box, insert, or invoice to open the right guide instantly.' },
      { icon: 'refresh', title: 'Always-current content', desc: 'Update instructions, safety notes, or product resources without reprinting packaging or sending replacement documents.' },
      { icon: 'eye', title: 'Self-serve answers', desc: 'Give customers a cleaner way to find product information after purchase and reduce repeated support questions.' },
      { icon: 'globe', title: 'Multi-channel access', desc: 'Surface guides from registration pages, digital warranty cards, customer portals, and post-purchase emails.' },
      { icon: 'chart-bar', title: 'Guide usage insights', desc: 'Track what content customers open most often so product and support teams can improve documentation over time.' },
    ],
  },
  {
    id: 'analytics',
    eyebrow: 'Analytics and Insights',
    headline: 'See exactly where your warranty operation stands',
    headlineEm: 'warranty operation stands',
    body: 'Most warranty data lives in spreadsheets or across disconnected tools. Dyrect brings registration rates, claim costs, defect trends, and extended warranty revenue into one dashboard. Your product, service, and finance teams all get the numbers they need to act.',
    productPage: null,
    productLabel: null,
    items: [
      { icon: 'chart-bar', title: 'Registration rate by product',     desc: 'See which products get registered and which channels drive the most registrations. Identify coverage gaps before they compound.' },
      { icon: 'gauge',     title: 'Claim frequency by SKU',           desc: 'Which products generate the most claims? Which defect types recur? Your product and quality teams need this to act on root causes.' },
      { icon: 'wallet',    title: 'Cost per claim tracking',          desc: 'Track average resolution cost across repair, replacement, and refund types. Find where claims budgets leak and cut the right lines.' },
      { icon: 'trend',     title: 'Defect trend detection',           desc: 'Spot rising defect rates before they become a recall or a review crisis. Early signals surface across every SKU in your catalog.' },
      { icon: 'star',      title: 'Extended warranty revenue',        desc: 'Total protection plan revenue, attach rate by product line, and plan performance over time. See what earns and what needs repricing.' },
      { icon: 'download',  title: 'BI and data export',               desc: 'Download any report as CSV or connect to Looker, Tableau, or your data warehouse via API. Your data stays yours.' },
    ],
  },
  {
    id: 'platform',
    eyebrow: 'Platform and Integrations',
    headline: 'Works with the tools your team already runs',
    headlineEm: 'tools your team already runs',
    body: 'Dyrect connects to your Shopify store, WooCommerce site, CRM, and data warehouse. Native integrations sync orders and registrations automatically. The REST API and webhook support handle anything custom your stack requires.',
    productPage: null,
    productLabel: null,
    items: [
      { icon: 'store',   title: 'Shopify app (5-star rated)',     desc: 'Native app in the Shopify App Store. Syncs orders, product variants, and customer data automatically. Rated 5 stars by merchants.' },
      { icon: 'plug',    title: 'WooCommerce plugin',             desc: 'Install on any WooCommerce store. Extended warranty offers and registration forms activate without custom development.' },
      { icon: 'api',     title: 'REST API',                       desc: 'Full API access to warranties, claims, registrations, and customer records. Comprehensive documentation included.' },
      { icon: 'webhook', title: 'Webhook support',                desc: 'Push real-time events to your CRM, ERP, or data warehouse when claims or registrations change state. No polling needed.' },
      { icon: 'users',   title: 'Role-based access control',      desc: 'Set team permissions by role. Service agents, managers, and admins each see what they need and nothing they should not.' },
      { icon: 'lock',    title: 'SSO and SAML support',           desc: 'Enterprise-grade authentication. Connect to Okta, Azure AD, or any SAML provider. No separate password management required.' },
      { icon: 'palette', title: 'White-label portal and emails',  desc: 'Every customer touchpoint carries your brand. Registration pages, warranty cards, and status emails show your logo and domain.' },
      { icon: 'csv',     title: 'CSV import and export',          desc: 'Migrate existing registrations from any source. Export any data set for offline analysis or bulk operations any time.' },
    ],
  },
];

/* ─── Feature section (inside the right content column) ─── */
function FeatureSection({ data, isLast }) {
  const cols = data.items.length >= 7 ? 3 : data.items.length >= 5 ? 3 : 2;
  const parts = data.headlineEm ? data.headline.split(data.headlineEm) : null;

  return (
    <section id={data.id} data-screen-label={data.eyebrow}
      style={{ padding: '64px 48px', borderBottom: isLast ? 'none' : '1px solid var(--border-default)' }}>

      {/* Header */}
      <div style={{ maxWidth: 680 }}>
        <p className="eyebrow" style={{ marginBottom: 12 }}>{data.eyebrow}</p>
        <h2 className="section-title" style={{ textAlign: 'left', letterSpacing: '-1.2px', fontSize: 'clamp(26px, 3vw, 38px)' }}>
          {parts ? <>{parts[0]}<span className="em">{data.headlineEm}</span>{parts[1]}</> : data.headline}
        </h2>
        <p style={{ marginTop: 14, fontSize: 16, lineHeight: 1.65, color: '#475569' }}>
          {data.body}
        </p>
        {data.productPage && (
          <a href={data.productPage} style={{
    ...
    <>
      ...
      <main>
        ...
        <div style={{ borderTop: '1px solid var(--border-default)' }}>
          <div className="features-layout-grid" style={{
            ...
            <div>
              {SECTION_DATA.map((data, i) => (
                <FeatureSection key={data.id} data={data} isLast={i === SECTION_DATA.length - 1} />
              ))}
            </div>
          </div>
        </div>
        ...
        <FinalCTA
          title="Ready to run a better warranty operation?"
          body={<>Join 500+ brands managing registration, claims, and extended warranties with Dyrect. <strong style={{ color: 'white' }}>Get set up in under 30 minutes.</strong></>}
